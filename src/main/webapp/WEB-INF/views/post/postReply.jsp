...
<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form action="/post/postReply" method="post" id="frm" enctype="multipart/form-data">
					<label> 제목 
					<input type="hidden" name="post_id2" value="${postVo.post_id}">
					<input type="hidden" name="post_group" value="${postVo.post_group}">
					<input type="text" style="width: 300px; margin-bottom: 30px;" name="title">
					</label>
					<textarea name="contents" id="smarteditor" rows="10" cols="100" style="width:766px; height:412px;"></textarea> 
					<div id="re" class="form-group">
						<input type="file" name="files" onclick="btnclick()">
					</div>
